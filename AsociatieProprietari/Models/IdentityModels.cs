...
namespace AsociatieProprietari.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<FlatModels> FlatModels { get; set; }
        public DbSet<ContratModels> ContratModels { get; set; }
        public DbSet<InvoiceModels> InvoiceModels { get; set; }
        public DbSet<WaterConsumptionModels> WaterConsumptionModels { get; set; }
