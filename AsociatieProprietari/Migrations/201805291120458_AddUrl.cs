namespace AsociatieProprietari.Migrations
{
    ...
    public partial class AddUrl : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.WaterConsumptionModels",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        FlatId = c.Int(nullable: false),
                        HotCubeMeters = c.Single(nullable: false),
                        ColdCubeMeters = c.Single(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.WaterConsumptionModels");
            ...
            DropTable("dbo.FlatModels");
            DropTable("dbo.EmployeeModels");
            DropTable("dbo.ContratModels");
        }
    }
}
